...
if("TRUE" STREQUAL "TRUE")
  set(apriltag_ros_SOURCE_PREFIX /home/yws/UMV_Project/rotor/src/apriltag_ros/apriltag_ros)
  set(apriltag_ros_DEVEL_PREFIX /home/yws/UMV_Project/rotor/devel_isolated/apriltag_ros)
  ...
  set(apriltag_ros_INSTALL_PREFIX /home/yws/UMV_Project/rotor/install_isolated)
...
if(NOT "/home/yws/UMV_Project/rotor/devel_isolated/apriltag_ros/include;/home/yws/UMV_Project/rotor/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/apriltag;/usr/local/include/opencv " STREQUAL " ")
  set(apriltag_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/yws/UMV_Project/rotor/devel_isolated/apriltag_ros/include;/home/yws/UMV_Project/rotor/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/apriltag;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltag_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yws/UMV_Project/rotor/src/apriltag_ros/apriltag_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(apriltag_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "apriltag_ros_common;apriltag_ros_continuous_detector;apriltag_ros_single_image_detector;-lpthread;m;/usr/local/lib/libopencv_calib3d.so.3.4.15;/usr/local/lib/libopencv_core.so.3.4.15;/usr/local/lib/libopencv_dnn.so.3.4.15;/usr/local/lib/libopencv_features2d.so.3.4.15;/usr/local/lib/libopencv_flann.so.3.4.15;/usr/local/lib/libopencv_highgui.so.3.4.15;/usr/local/lib/libopencv_imgcodecs.so.3.4.15;/usr/local/lib/libopencv_imgproc.so.3.4.15;/usr/local/lib/libopencv_ml.so.3.4.15;/usr/local/lib/libopencv_objdetect.so.3.4.15;/usr/local/lib/libopencv_photo.so.3.4.15;/usr/local/lib/libopencv_shape.so.3.4.15;/usr/local/lib/libopencv_stitching.so.3.4.15;/usr/local/lib/libopencv_superres.so.3.4.15;/usr/local/lib/libopencv_video.so.3.4.15;/usr/local/lib/libopencv_videoio.so.3.4.15;/usr/local/lib/libopencv_videostab.so.3.4.15;/usr/local/lib/libopencv_viz.so.3.4.15")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yws/UMV_Project/rotor/devel_isolated/apriltag_ros/lib;/home/yws/Project/dji-sim/devel/lib;/home/yws/Project/rotors_gazebo/catkin_ws/devel/lib;/home/yws/ros/autolabor_ws/devel/lib;/home/yws/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
