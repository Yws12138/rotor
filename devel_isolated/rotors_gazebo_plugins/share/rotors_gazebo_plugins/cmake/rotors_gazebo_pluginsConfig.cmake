...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/yws/UMV_Project/rotor/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/yws/UMV_Project/rotor/devel_isolated/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/yws/UMV_Project/rotor/install_isolated)
...
if(NOT "/home/yws/UMV_Project/rotor/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/yws/UMV_Project/rotor/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yws/UMV_Project/rotor/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rotors_gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rotors_gazebo_motor_model;rotors_gazebo_controller_interface;/usr/local/lib/libopencv_calib3d.so.3.4.15;/usr/local/lib/libopencv_core.so.3.4.15;/usr/local/lib/libopencv_dnn.so.3.4.15;/usr/local/lib/libopencv_features2d.so.3.4.15;/usr/local/lib/libopencv_flann.so.3.4.15;/usr/local/lib/libopencv_highgui.so.3.4.15;/usr/local/lib/libopencv_imgcodecs.so.3.4.15;/usr/local/lib/libopencv_imgproc.so.3.4.15;/usr/local/lib/libopencv_ml.so.3.4.15;/usr/local/lib/libopencv_objdetect.so.3.4.15;/usr/local/lib/libopencv_photo.so.3.4.15;/usr/local/lib/libopencv_shape.so.3.4.15;/usr/local/lib/libopencv_stitching.so.3.4.15;/usr/local/lib/libopencv_superres.so.3.4.15;/usr/local/lib/libopencv_video.so.3.4.15;/usr/local/lib/libopencv_videoio.so.3.4.15;/usr/local/lib/libopencv_videostab.so.3.4.15;/usr/local/lib/libopencv_viz.so.3.4.15")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yws/UMV_Project/rotor/devel_isolated/rotors_gazebo_plugins/lib;/home/yws/UMV_Project/rotor/devel_isolated/rotors_evaluation/lib;/home/yws/UMV_Project/rotor/devel_isolated/rotors_description/lib;/home/yws/UMV_Project/rotor/devel_isolated/rotors_control/lib;/home/yws/UMV_Project/rotor/devel_isolated/rotors_comm/lib;/home/yws/UMV_Project/rotor/devel_isolated/realsense_ros_gazebo/lib;/home/yws/UMV_Project/rotor/devel_isolated/mav_system_msgs/lib;/home/yws/UMV_Project/rotor/devel_isolated/mav_state_machine_msgs/lib;/home/yws/UMV_Project/rotor/devel_isolated/mav_planning_msgs/lib;/home/yws/UMV_Project/rotor/devel_isolated/mav_msgs/lib;/home/yws/UMV_Project/rotor/devel_isolated/mav_comm/lib;/home/yws/UMV_Project/rotor/devel_isolated/glog_catkin/lib;/home/yws/UMV_Project/rotor/devel_isolated/catkin_simple/lib;/home/yws/UMV_Project/rotor/devel_isolated/apriltag_ros/lib;/home/yws/Project/dji-sim/devel/lib;/home/yws/Project/rotors_gazebo/catkin_ws/devel/lib;/home/yws/ros/autolabor_ws/devel/lib;/home/yws/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
