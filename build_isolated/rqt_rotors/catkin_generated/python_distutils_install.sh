...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/yws/UMV_Project/rotor/install_isolated/lib/python2.7/dist-packages:/home/yws/UMV_Project/rotor/build_isolated/rqt_rotors/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/yws/UMV_Project/rotor/build_isolated/rqt_rotors" \
    "/usr/bin/python2" \
    "/home/yws/UMV_Project/rotor/src/rotors_simulator/rqt_rotors/setup.py" \
     \
    build --build-base "/home/yws/UMV_Project/rotor/build_isolated/rqt_rotors" \
    install \
    --root="${DESTDIR-/}" \
